...
xs=range(1,n_it+1)
plt.figure()
plt.errorbar(xs, acc_active_av, acc_active_sem, fmt='o-', capsize=3, capthick=1, label="Active", color='blue')
plt.errorbar(xs, acc_passive_av, acc_passive_sem, fmt='o-', capsize=3, capthick=1, label="Passive", color='green')
...
plt.figure()
plt.errorbar(xs, complexity_active_av, complexity_active_sem, fmt='o-', capsize=3, capthick=1, label="Active", color='blue')
plt.errorbar(xs, complexity_passive_av, complexity_passive_sem, fmt='o-', capsize=3, capthick=1, label="Passive", color='green')
plt.xlabel('Size of the training set', fontsize=35)
...
plt.figure()
plt.errorbar(xs, nhyp_active_av, nhyp_active_sem, fmt='o-', capsize=3, capthick=1, label="Active", color='blue')
plt.errorbar(xs, nhyp_passive_av, nhyp_passive_sem, fmt='o-', capsize=3, capthick=1, label="Passive", color='green')
plt.xlabel('Size of the training set', fontsize=35)
...
plt.figure()
plt.errorbar(xs, entropy_active_av, entropy_active_sem, fmt='o-', capsize=3, capthick=1, label="Active", color='blue')
plt.errorbar(xs, entropy_passive_av, entropy_passive_sem, fmt='o-', capsize=3, capthick=1, label="Passive", color='green')
plt.xlabel('Size of the training set', fontsize=35)
